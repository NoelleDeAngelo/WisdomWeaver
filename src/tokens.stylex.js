...
export const colors = stylex.defineVars({
  ...
  //Dark Sections//
  darkBackground: { default: "#495a58" },
  darkHeading: { default: "#f2a893" },
...
export const shadows = stylex.defineVars({
  ...
  cardOnDark:  "0 1px 2px rgba(255, 255, 255, 0.1), 0 4px 20px rgba(0, 0, 0, 0.35)",
  button:"box-shadow: 0 6px 16px rgba(244, 93, 72, 0.25)",
  sepia: "brightness(0.9) contrast(1.1) sepia(0.1)",
  text: "0 1px 1px rgba(0, 0, 0, 0.15)",
});