    ...
    <div {...stylex.props(styles.aboutSection)}>
      ...
      <div {...stylex.props(styles.about)}>
        ...
        <p {...stylex.props(styles.aboutText)}>
          ...
          yourself. Whether you&apos;re navigating a career transition, seeking
          to improve your well-being, or striving for greater fulfillment, we
          are here to provide the guidance, support, and encouragement you need
          to thrive. Get to know us more and discover how our transformative
